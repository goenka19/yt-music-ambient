...
1. [Download or clone this repository](https://github.com/goenka19/yt-music-ambient)
2. Open `chrome://extensions/`
3. Enable **Developer mode** (top right toggle)
4. Click **Load unpacked** and select the project folder
5. Navigate to [music.youtube.com](https://music.youtube.com) and play a song
...
See [CLAUDE.md](CLAUDE.md) for a full architecture breakdown, code patterns, and development notes.
...
Pull requests are welcome. Please read [CLAUDE.md](CLAUDE.md) before contributing — it documents the code patterns, selector resilience strategy, and debugging approach used throughout the codebase.
